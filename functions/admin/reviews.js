...
async function generateSingleReviewWithAI(env, product) {
  ...
  const prompt = `Ти — український фермер або дачник. Напиши 1 короткий, природний відгук ВИКЛЮЧНО українською мовою на агротовар "${product.name}" (категорія: ${product.category}${product.brand ? ', бренд: ' + product.brand : ''}).

${context}

Вимоги:
- Відгук має бути довжиною від 50 до 140 символів.
- Пиши просто, як звичайна людина, граматично правильною українською мовою (правильні відмінки та рід).
- КАТЕГОРИЧНО ЗАБОРОНЕНО: жодного російського слова чи суржику (наприклад, "ярко-зелений" — неправильно, треба "яскраво-зелений"); жодних вигаданих чи безглуздих словосполучень, які не мають сенсу українською.
- Якщо не маєш конкретної інформації про товар — пиши загальні, але осмислені враження (якість, зручність, чи буде купувати знову), а не вигадуй дивні деталі.

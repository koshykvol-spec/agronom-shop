...
- Довжина відгуку: 100–140 символів. Пиши просто, як звичайна людина — без реклами, пафосу, "!!!", трикрапок.
- Якщо не маєш конкретної інформації про товар — пиши загальні, але осмислені враження (якість, зручність, чи купуватимеш знову, чи рекомендуєш іншим покупцям), а не вигадуй дивні деталі чи характеристики.
- Автор — обери ІМ'Я З ЦЬОГО СПИСКУ (кожне ім'я можна використати не більше 2 разів на всю відповідь): ${namesForPrompt}
- Рейтинг: приблизно 5/6 відгуків — 5 зірок, решта — 4 зірки.
